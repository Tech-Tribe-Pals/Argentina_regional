    ...
    <ContainerInfo>
      <Section>
        <Article>
          ...
          <PictureProfe>
            <img src="./sobreMi/Jorge_Lapena.png" alt="JorgeLapena" />
          </PictureProfe>
        ...
        <Article className="Nosotros">
          <ContentWrapper>
            <Picture>
              <img src="./sobreMi/Fede.jfif" width={150} alt="FedericoMassolo" />
            </Picture>
          ...
          <ContentWrapper>
            ...
            <ul>
              ...
              <li>
                <img src="./Iconos/contact.svg" width={30} alt="img-contacto" />
              </li>
              <li>
                <a
          ...
          <ContentWrapper>
            <Picture>
              <img src="./sobreMi/Adriel.jfif" height={150} width={150} alt="" />
            </Picture>
            <h3>Adriel Camacho</h3>
            <p>
              Alumno de la carrera de Analista de Sistemas
            </p>
            <p>
